...
#     question="?x.price(x)"
#     key_strvalue ="" 
#     for key in domain.plans:
#         print("domain.plans?�� key�?[{}],type[{}]".format(key, type(key)))
#         print("question�?[{}],type[{}]".format(question, type(question)))
#         print("key.__str__()�?[{}]".format(key.__str__()))
#         key_strvalue = key.__str__()
#         if key_strvalue == question:
#             print("key is question[{}]".format(question))
#             for construct in reversed(domain.plans[key]):

...
#     print("get_latest_moves--> IS.shared.lu.moves[{}]".format(IS.shared.lu.moves))
#     print("get_latest_moves--> IS.shared.lu.speaker[{}]".format(IS.shared.lu.speaker))
...
#     print("integrate_usr_ask--> IS.private.agenda[{}]".format(IS.private.agenda))
#     print("integrate_usr_ask--> IS.shared.qud[{}]".format(IS.shared.qud))
...
def integrate_answer(IS, DOMAIN):
    ...
    """
#     print("integrate_answer--> ?��?��  IS.shared.qud[{}]".format(IS.shared.qud))
#     print("integrate_answer--> ?��?��  IS.shared.lu.moves[{}]".format(IS.shared.lu.moves))
    
    @precondition
    def V():
        que = IS.shared.qud.top()
#         print("integrate_answer--> IS.shared.qud.top()=que[{}]".format(que))
        for move in IS.shared.lu.moves:
#             print("integrate_answer--> IS.shared.lu.moves move[{}]".format(move))
            if isinstance(move, Answer):
#                 print("integrate_answer--> Answer-->move.content[{}]".format(move.content))
                if DOMAIN.relevant(move.content, que):
#                     print("integrate_answer--> DOMAIN.relevant(move.content, que)-->true")
                    yield R(que=que, ans=move.content)
#     print("integrate_answer--> V.que[{}]".format(V.que))
#     print("integrate_answer--> V.ans[{}]".format(V.ans))
    prop = DOMAIN.combine(V.que, V.ans)
#     print("integrate_answer--> DOMAIN.combine(V.que, V.ans)[{}]".format(prop))
    IS.shared.com.add(prop)
#     print("integrate_answer--> IS.shared.com[{}]".format(IS.shared.com))
#     print("integrate_answer--> 종료")

...
class Type(object): 
    ...
    """append by phs 2018.01.17, 
     Python3 need this method.
    """
...
class SimpleOutput(DialogueManager):
    ...
    @update_rule
    def generate(self, NEXT_MOVES, OUTPUT, GRAMMAR):
    ...
    @update_rule
    def output(self, NEXT_MOVES, OUTPUT, LATEST_SPEAKER, LATEST_MOVES):
...
class SimpleInput(object):
    ...
    @update_rule
    def interpret(self, INPUT, LATEST_MOVES, GRAMMAR):
    ...
    @update_rule
    def input(self, INPUT, LATEST_SPEAKER):
